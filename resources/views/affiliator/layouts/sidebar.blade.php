<nav class="flex-1 px-2 pb-4 space-y-1">
    ...
    <a href="{{route('admin.affiliator')}}" class="bg-indigo-800 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md nav-link {{ request()->routeIs('dashboard') ? 'active' : null}}">
