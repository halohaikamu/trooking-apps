                    ...
                    <div class="grid grid-cols-8 gap-4 mb-4">
                        <div class="col-span-7">
                            <form action="" method="GET">
                                <input type="text" name="search" class="w-full bg-gray-200 p-2 rounded shadow-sm border border-gray-200 focus:outline-none focus:bg-white" placeholder="ketik nomer resi">
                            </form>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <button class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"><a href="{{ route('admin-trackings.edit',$item->id) }}">EDIT</a></button>
