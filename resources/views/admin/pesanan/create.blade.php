        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    ...
                    <select id="name_id" name="name_id" autocomplete="name_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <select id="username_id" name="username_id" autocomplete="username_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <select onchange="fillPrice()" id="origin" name="origin" autocomplete="origin" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            ...
            <div>
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <textarea rows="2" name="penjemputan" id="penjemputan" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"></textarea>
                    @error('penjemputan')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <select onchange="fillPrice()" id="destinasi" name="destinasi" autocomplete="destinasi" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            ...
            <div>
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <textarea rows="2" name="pengantaran" id="pengantaran" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"></textarea>
                    @error('pengantaran')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <select onchange="fillPrice()" id="berat_id" name="berat_id" autocomplete="berat_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <select id="dimensi_id" name="dimensi_id" autocomplete="dimensi_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <select id="jenis_barang_id" name="jenis_barang_id" autocomplete="jenis_barang_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <select id="packing" name="packing" autocomplete="packing" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <select id="voucher_id" name="voucher_id" autocomplete="voucher_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <select id="jenis_pembayaran_id" name="jenis_pembayaran_id" autocomplete="jenis_pembayaran_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
